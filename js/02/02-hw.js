...
// 3)	Напишите функцию JavaScript для сортировки массива объектов по допределенному свойству в порядке возрастания, используя метод Array.prototype.sort()(тут кастомная сортировка придется чуть-чуть поискать и подумать)
// const persons = [
//     {name: 'Alice', age: 30},
//     {name: 'Bob', age: 25},
//     {name: 'Charlie', age: 35},

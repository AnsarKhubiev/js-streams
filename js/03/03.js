...
// ]; // ..(number)
//
// const totalBudget = people.reduce((acc, item) => acc + item.budget, 0)
...
//
// const minNumber = arr.reduce((acc, number)=> acc < number ? acc : number)
